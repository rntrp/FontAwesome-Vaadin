...
public class FontAwesomeLabel extends Label {
    ...
    public String getCssHtml() {
        if (stacked == null) {
            return "<i class=\"" + getCssClasses(false) + "\"" + (custom != null ? "style=\"" + custom + "\"" : "")
                    + "></i>";
        }
        ...
        return "<span class=\"fa-stack " + (stackSize != null ? stackSize : "") + "\">" + "<i class=\""
                + getCssClasses(true) + "\"" + (custom != null ? "style=\"" + custom + "\"" : "") + "></i>"
                + "<i class=\"" + stacked.getCssClasses(true) + "\""
                + (stacked.custom != null ? "style=\"" + stacked.custom + "\"" : "") + "></i>" + "</span>";
    }
